...
class Params:
    ...
    def __init__ (self):
        ...
        self.SB_set = [i for i in range(self.SB)]


        # todo : Formel einbauen, die für gegebene Einwohnermenge die anzahl der nötigen gigacenter jedes typen ermittelt
        self.SB_subset_gc = [4]
